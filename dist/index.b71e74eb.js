...
function main() {
    const controller = new (0, _controller.Controller)();
    controller.init();
}
main();

},{"./mvc/controller":"a6AiL"}],"a6AiL":[function(require,module,exports) {
...
class Controller {
    model = new (0, _model.Model)();
    view = new (0, _view.View)(this);
    init() {
...
},{"./model":"3IU3E","./view":"ksva0","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3IU3E":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class Model {
    value = "0";
    shouldAppendDecimal = false;
    isDisplayingResult = false;
    continueOperation = false;
    get stringValue() {
        const value = this.value ?? this.register;
        const parsed = parseFloat(value);
        if (parsed > 999999999 || parsed < -99999999 || parsed !== 0 && Math.abs(parsed) < 0.000001) return "Err";
        return value;
    }
    appendDigit(digit) {
        if (this.selectedOperation !== undefined && this.register === undefined || this.isDisplayingResult) {
            this.register = this.value;
            this.value = undefined;
            this.isDisplayingResult = false;
        }
        if (this.value === undefined) this.value = digit.toString();
        else if (this.value.length < 9 && this.value !== "Err") {
            if (this.value === "0") this.value = digit.toString();
            else this.value += digit.toString();
        }
    ...
    didSelectOperator(op) {
        switch(op){
            case (0, _events.Operator).div:
            case (0, _events.Operator).mul:
            case (0, _events.Operator).sub:
            case (0, _events.Operator).add:
                if (this.register === undefined || this.selectedOperation !== op || this.continueOperation) this.selectOperation(op);
                else this.performBinaryOperation(op);
                break;
            case (0, _events.Operator).eq:
                if (this.selectedOperation !== undefined) {
                    if (this.register === undefined) this.register = this.value;
                    else if (this.value === undefined) this.value = this.register;
                    this.performBinaryOperation(this.selectedOperation);
                }
                this.isDisplayingResult = true;
                break;
            default:
                if (this.value === undefined) this.value = this.register;
    ...
    performUnaryOperation(op) {
        let value = parseFloat(this.value);
        switch(op){
            case (0, _events.Operator).negate:
                value = -value;
                break;
            case (0, _events.Operator).percent:
                value = value / 100;
                break;
            default:
                break;
    ...
    valueToString(value) {
        ...
        if (stringVal.includes(".")) stringVal = stringVal.replace(/\.?0*$/, "");
        return stringVal;
    }
}

},{"./events":"7og2t","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"7og2t":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "Operator", ()=>Operator);
let Operator;
(function(Operator) {
    Operator[Operator["div"] = 0] = "div";
    Operator[Operator["mul"] = 1] = "mul";
    Operator[Operator["sub"] = 2] = "sub";
    Operator[Operator["add"] = 3] = "add";
    Operator[Operator["eq"] = 4] = "eq";
    Operator[Operator["negate"] = 5] = "negate";
    Operator[Operator["percent"] = 6] = "percent";
})(Operator || (Operator = {}));
...
},{}],"ksva0":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class View {
    ...
    elemForKey(e) {
        ...
        switch(e.key){
            ...
            case "-":
            case "–":
                return e.altKey ? document.getElementById("negate") : document.getElementById("sub");
            case "%":
    ...
    handleButtonClicked(button) {
        const type = button.getAttribute("calc-button-type") ?? button.parentElement?.getAttribute("calc-button-type");
        switch(type){
            case "num":
    ...
    async modelDidUpdate(model) {
        ...
        if (model.selectedOperation != null) switch(model.selectedOperation){
            case (0, _events.Operator).div:
    ...
    parseOperator(name) {
        switch(name){
            case "negate":
                return (0, _events.Operator).negate;
            case "percent":
                return (0, _events.Operator).percent;
            case "div":
                return (0, _events.Operator).div;
            case "mul":
                return (0, _events.Operator).mul;
            case "sub":
                return (0, _events.Operator).sub;
            case "add":
                return (0, _events.Operator).add;
            default:
                return (0, _events.Operator).eq;
        }
    }
}

},{"./events":"7og2t","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["3LmCz","h7u1C"], "h7u1C", "parcelRequire94c2")
